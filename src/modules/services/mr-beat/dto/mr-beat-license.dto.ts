import { FindMrBeatLicense } from '@/interface/mr-beat.interface';
import { Property } from '@/utils/swagger';

export interface MrBeatLicenseDTOProps {
  id: string;
  usePeriod?: string;
  cost: number;
...
export class MrBeatLicenseDTO {
  ...
  constructor(props?: MrBeatLicenseDTOProps) {
    if (props) {
      this.id = props.id;
  ...
  static fromFindMrBeatLicense(data: FindMrBeatLicense): MrBeatLicenseDTO {
    return new MrBeatLicenseDTO({
      id: data.id,
      usePeriod: data.usePeriod,
      cost: data.cost,
      isNewSongWithVoiceAllowed: data.isNewSongWithVoiceAllowed,
      isProfitActivityAllowed: data.isProfitActivityAllowed,
      isPerformanceActivityAllowed: data.isPerformanceActivityAllowed,
      isBackgroundMusicAllowed: data.isBackgroundMusicAllowed,
      isMVProduceAllowed: data.isMVProduceAllowed,
      isShareAllowed: data.isShareAllowed,
      isArrangeAllowed: data.isArrangeAllowed,
