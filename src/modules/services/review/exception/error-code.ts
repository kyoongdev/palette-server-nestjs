...
export const REVIEW_ERROR = {
  ...
  REVIEW_REPLY_NOT_FOUND: '리뷰 댓글을 찾을 수 없습니다.',
  REVIEW_REPLY_ALREADY_EXISTS: '리뷰 댓글이 이미 존재합니다.',
  ONLY_OWNER_CAN_UPDATE_REPLY: '본인만 리뷰 댓글을 수정할 수 있습니다.',
  ONLY_OWNER_CAN_DELETE_REPLY: '본인만 리뷰 댓글을 삭제할 수 있습니다.',
};
...
export const REVIEW_ERROR_CODE: ErrorCode<typeof REVIEW_ERROR> = {
  ...
  REVIEW_REPLY_NOT_FOUND: {
    code: HttpStatus.NOT_FOUND,
    message: REVIEW_ERROR.REVIEW_REPLY_NOT_FOUND,
  },
  REVIEW_REPLY_ALREADY_EXISTS: {
    code: HttpStatus.CONFLICT,
    message: REVIEW_ERROR.REVIEW_REPLY_ALREADY_EXISTS,
  },
  ONLY_OWNER_CAN_UPDATE_REPLY: {
    code: HttpStatus.FORBIDDEN,
    message: REVIEW_ERROR.ONLY_OWNER_CAN_UPDATE_REPLY,
  },
  ONLY_OWNER_CAN_DELETE_REPLY: {
    code: HttpStatus.FORBIDDEN,
    message: REVIEW_ERROR.ONLY_OWNER_CAN_DELETE_REPLY,
  },
};
